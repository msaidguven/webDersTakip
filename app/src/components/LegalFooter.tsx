...
export function LegalFooter() {
  return (
    <footer className="border-t border-default py-6 sm:py-8 px-4 sm:px-8">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-3 sm:gap-4 text-center">
        ...
        <nav className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1.5 order-1 sm:order-2">
