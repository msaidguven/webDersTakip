...
// Bu 5 kısayolun hiçbirinin hedef sayfası henüz yok (bkz. docs/site-iyilestirme-plani.md) —
// kartlar referans tasarımla aynı görünsün diye duruyor ama bilerek link değil (404'e düşürmesin).
const ITEMS = [
  { icon: Layers, label: 'Üniteler', description: 'Tüm üniteleri görüntüle' },
  { icon: BookOpen, label: 'Konular', description: 'Konulara göz at' },
  { icon: FileQuestion, label: 'Soru Bankası', description: 'Binlerce soru çöz' },
