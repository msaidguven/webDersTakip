...
// Kullanıcı bir ünite/konu testini (ya da SRS tekrarını, unitId=null ile) yarım bırakıp
// sayfayı tekrar açtığında (yenileme, geri gelme vb.) sıfırdan yeni bir test_sessions satırı
// ve yeni rastgele soru seti açmak yerine son bitmemiş oturumu bulur ve aynı soru havuzuyla,
// zaten cevaplananları atlayarak devam ettirir. Öncesinde her sayfa yüklemesi ayrı bir oturum
// açıyordu ve hiçbiri bitmiyordu — bu da hem istatistiklerin (SRS, ünite özeti) hiç
// hesaplanmamasına hem de panelde "hiç aktivite yok" görünmesine yol açıyordu.
