...
import SvgQuestionsPanel from '@/app/src/components/admin/SvgQuestionsPanel';
import AdminThemeToggle from '@/app/src/components/admin/AdminThemeToggle';

export const dynamic = 'force-dynamic';

export default function SvgSorulariPage() {
  return (
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-10 bg-card border-b border-border px-4 sm:px-6 py-3 flex items-center gap-4">
        ...
        <h1 className="font-bold text-foreground text-sm sm:text-base flex-1">SVG Soruları</h1>
        <AdminThemeToggle />
      </header>
