...
// ile aynı). Liderlik tablosu ve yorumlar bu alanı gösteriyor (full_name yerine, gizlilik
// için — bkz. add_weekly_leaderboard_rpc.sql).
...
export async function PATCH(request: NextRequest) {
  ...
  // Yeni üye "profilini güncelle" uyarısı: sadece kapatılabilir (false), kullanıcı geri açamaz.
  if (rawPatch.profile_prompt_pending === false) patch.profile_prompt_pending = false;
  ...
  patch.profile_prompt_pending = false;
