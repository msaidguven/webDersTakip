...
// LEGACY — sadece redirect, yeni UI'dan buraya link VERME. Eski alt başlığa özel kavrama
// testi URL'i artık yok — tek bir konu artık TEK kavrama testinde birleşiyor (bkz.
// ../page.tsx). Buraya gelen (indexlenmiş olabilecek) eski bağlantıları kalıcı olarak
// konunun kavrama testine yönlendiriyoruz.
