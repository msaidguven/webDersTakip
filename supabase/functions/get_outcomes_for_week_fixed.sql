-- ESKİ FONKSİYONU SİL
DROP FUNCTION IF EXISTS get_outcomes_for_week(bigint, bigint, integer);

-- YENİ DÜZELTİLMİŞ FONKSİYON
...
BEGIN
    ...
    WHERE
        ...
        AND lg.grade_id = p_grade_id  -- BURASI DÜZELTİLDİ: lg.grade_id kullan
