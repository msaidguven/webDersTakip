...
-- job'u GÜNCELLER (yeni bir tane eklemez) — burada 2 saatte bir'e (12/gün) çekiliyor:
-- 20/gün kotasının rahat altında kalıp admin panelinden elle tetiklenen üretimlere de
-- (aynı key'i paylaşan app/api/admin/topic-sections/classical-questions/generate) pay
-- bırakıyor.
--
